= APPUiO Managed Cloud Kubernetes Documentation

This repository contains all the content of the APPUiO Managed Cloud Kubernetes documentation hosted at https://kb.vshn.ch/cloud-kubernetes/.
